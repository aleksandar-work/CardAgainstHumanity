      ...
      const error = this.state.error;
        return (
            <View style={styles.container}>
                <Text style={{fontSize: 40, fontWeight: 'bold', marginTop: '30%'}}>Type code</Text>
                <TextInput 
                  style={{marginTop: '3%', width: '50%', height: 40, color: '#000', fontSize: 28, borderWidth: 2, borderRadius: 5, textAlign: 'center'}} 
                  autoCorrect = {false}
                ...
                />
                <Text style={{fontSize: 40, fontWeight: 'bold', marginTop: '10%'}}>Type Name</Text>
                <TextInput 
                  style={{marginTop: '3%', width: '50%', height: 40, color: '#000', fontSize: 28, borderWidth: 2, borderRadius: 5, textAlign: 'center'}} 
                  autoCorrect = {false}                  
                  onChangeText = {text => {
                ...
                <View style={{marginTop: '10%'}}>
                  <TouchableOpacity onPress={() =>
                    ...
                    <Text style={{backgroundColor: '#000', color: '#fff', fontSize:30, fontWeight: 'bold', paddingTop: 10, paddingBottom: 10, paddingRight: 30, paddingLeft: 30, borderRadius: 10}}>Join</Text>
                  </TouchableOpacity>
                </View>
                <View style={{marginTop: '10%'}}>
                  <TouchableOpacity onPress={() =>
